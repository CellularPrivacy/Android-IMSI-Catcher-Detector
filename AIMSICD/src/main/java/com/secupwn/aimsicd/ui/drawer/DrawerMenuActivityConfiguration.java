...
public class DrawerMenuActivityConfiguration {
    ...
    public static class Builder {
        ...
        public DrawerMenuActivityConfiguration build() {
            ...
            menu.add(DrawerMenuItem.create(DrawerMenu.ID.MAIN.NEIGHBOURING_CELLS, mContext.getString(R.string.cell_info_title), R.drawable.cell_tower, true));                      // Neighbouring Cell Information
